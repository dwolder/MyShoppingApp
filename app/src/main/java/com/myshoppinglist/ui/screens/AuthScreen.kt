...
fun AuthScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(16.dp))
            Text(
                text = if (isSignUp) "Create your account to sync lists with family"
                else "Sign in to sync your shopping lists",
